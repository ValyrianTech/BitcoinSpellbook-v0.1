...
def get_NavigationHTML(url, url_linktext, spellbook_urls=[], isAdmin=False):
    ...
    html += "</ul></li>"
    html += "<li><a href='/documentation' accesskey='2' title=''>Documentation</a></li>"
    if isAdmin:
        html += "<li><a href='/admin' accesskey='3' title=''>Admin</a></li>"
        html += "<li><a href='" + url + "' accesskey='4' title=''>" + url_linktext + "</a></li>"
...
def get_CssHTML():
    ...
    html += "<link href='stylesheets/DistributeBTC.css' rel='stylesheet' type='text/css'>"
    return html


def get_MetaHTML():
    html = "<meta http-equiv='Content-Type' content='text/html; charset=iso-8859-1'>"
    html += "<META name='HDforward'><META name='keywords' content='Bitcoin, Blockchain, Bitcoin Spellbook, Blockchaindata, Simplified Inputs List, Blocklinker, Proportional Random, Bitvoter, HDForwarder, DistributeBTC, BitcoinWells, Valyrian Tech'>"
    return html
